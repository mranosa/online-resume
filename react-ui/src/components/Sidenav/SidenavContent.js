  ...
  render() {
    ...
    return (
      <ul className="nav" ref={(c) => { this.nav = c; }}>
        ...
        <li><FlatButton id="workstations" href="#/app/workstations"><i className="nav-icon material-icons">computer</i><span className="nav-text">Battlestations</span></FlatButton></li>        
      </ul>
    );
  }
}
